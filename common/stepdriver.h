// Code to control stepper drivers using the Allegro A4988, TI DRV8825, or 
// equivalent. This involves controlling 3 pins: direction, step, and enable.
...
/*
// Timer 0 can output pulses to PD5 and/or PD6 without CPU or interrupts.
// So only PORTD can be used.
#define USE_TIMER_0_FOR_STEPPER 1
#define STEPPER_PORT            PORTD      // Must be D
...
// Timer 2 can pulse to PB3 and/or PD3 without CPU or interrupts. Thus either
